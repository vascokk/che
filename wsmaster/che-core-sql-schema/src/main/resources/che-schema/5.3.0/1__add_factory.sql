...
-- constraints
ALTER TABLE che_factory_action_properties ADD CONSTRAINT fk_che_f_action_props_action_entity_id FOREIGN KEY (action_entity_id) REFERENCES ACTION (entity_id);
--------------------------------------------------------------------------------
...
CREATE TABLE che_factory_on_app_closed_action_value (
    ...
    PRIMARY KEY (on_app_closed_id, actions_entity_id)
);
-- constraints
